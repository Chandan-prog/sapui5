		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ecommerce app",
									"targetURL": "#epecommercemodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"epecommercemodule-display": {
								"semanticObject": "epecommercemodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ep.ecommercemodule",
									"url": sap.ui.require.toUrl("ep/ecommercemodule")
								}
							}
						}
					}
